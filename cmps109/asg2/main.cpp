...
void do_arith (bigint_stack& stack, const char oper) {
   ...
   bigint result;
   switch (oper) {
      case '+': result = left + right; break; //IMPLEMENT DOBIGADD
      case '-': result = left - right; break; //IMPLEMENT DOBIGSUB
      case '*': result = left * right; break; //IMPLEMENT DOBIGMUL
      case '/': result = left / right; break; //IMPLEMENT DOBIGDIV
      case '%': result = left % right; break; //IMPLEMENT DOBIGMOD
      case '^': result = pow (left, right); break; //IMPLEMENT BIGPOW?
