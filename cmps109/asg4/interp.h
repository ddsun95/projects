...
class interpreter {
   ...
   private:
      ...
      static void doMoveBy                (param begin, param end);
      static void doBorder                (param begin, param end);
      ...
      static shape_ptr makeDiamond        (param begin, param end);
      ...
      static shape_ptr makeTriangle       (param begin, param end);
      static shape_ptr makeEquilateral    (param begin, param end);
      static shape_ptr makeIsosceles      (param begin, param end);
      static shape_ptr makeRightTriangle  (param begin, param end);
};
